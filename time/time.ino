...
static const char ntpServerName[] = "ntp.ntsc.ac.cn"; //NTP服务器
...
char sta_ssid[32] = {"Apple"};          //暂存WiFi名
char sta_password[64] = {"2528184787"};      //暂存WiFi密码
const char *AP_NAME = "Riddle"; //自定义8266AP热点名
//配网及目标日期设定html页面
...
void connectWiFi()
{
    ...
    while (WiFi.status() != WL_CONNECTED)
    {
        ...
        { //依然没有自动连上，开启Web配网功能，可视情况调整等待时长
            ...
            Serial.println("Connect the WiFi named Riddle, the configuration page will pop up automatically, if not, use your browser to access 192.168.4.1");
...
void setup()
{
    ...
    Serial.println("Designed by Riddle");
    initdisplay();
    u8g2.clearBuffer();
